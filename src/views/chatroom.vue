  ...
  <v-app id="inspire">
    ...
    <v-app-bar class="px-3" color="grey-lighten-4" height="72" flat>
      ...
      <v-responsive max-width="156">
        ...
        <v-btn id="logoutBtn" rounded="pill" prepend-icon="mdi-logout" @click="Logout">Logout</v-btn>
        <!-- <v-text-field
    ...
    <v-footer height="72" app>
      <toolbar></toolbar>
      <v-text-field v-model="messageContent" bg-color="grey-lighten-2" class="overflow-hidden" density="compact"
        rounded="pill" variant="solo-filled" flat hide-details placeholder="Type a message" @keydown.enter="send">
